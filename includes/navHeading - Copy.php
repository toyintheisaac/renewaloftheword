...
<div class='container-fliud d-none'>    
 <nav class="bg-dark p-0 firstHeading">
  ...
  <ul class="navbar-nav" style='font-size:13px;'>
    ...
    <li class="nav-item">
      <a class="nav-link text-light" href="<?php echo dirHompg();?>relationship.php">Relationship</a>
    </li>
    <li class="nav-item">
      <a class="nav-link text-light" href="<?php echo dirHompg();?>testimony.php">Testimonies</a>
    </li>
...
<div class='container mt-4 mb-4'>    
 <nav class="secondHeading clearfix"> 
  <!-- Brand -->
  <a class="text-dark" href="<?php echo dirHompg();?>index.php"><img src='<?php echo dirHompg();?>img/logo2.png' class='' width='130px'/></a>
...
<?php if(userloggedin()===true){ ?>
	<?php if($USERstatus!=5 && $USERstatus!=10){ ?>
	   <a class="dropdown-item" href="contact-us.php">Make A Post</a>
	<?php } ?>
	<?php if(!empty($USERstatus) && ($USERstatus==5 || $USERstatus==10)){ ?>
	   <a class="dropdown-item" href="new-post.php">New Post</a>
	   <a class="dropdown-item" href="all-post.php">All Post</a>
	<?php } ?>
