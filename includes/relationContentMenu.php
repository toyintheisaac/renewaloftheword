...
<?php
$pageArticleQuery = $conn->query("SELECT * FROM article WHERE article_tags LIKE '%christian relationship%' AND `article_status` = 5  ORDER BY article_date DESC LIMIT 10");
