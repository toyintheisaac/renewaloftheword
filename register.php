...
if(!empty($_SESSION['comingFrom'])){
		$comingFrom = $_SESSION['comingFrom'];
}else{
		$comingFrom	= $directedFrom2;
		$_SESSION['comingFrom'] = $comingFrom ;
}
?>
<!DOCTYPE html> 
<html lang="en" >
<head>
	<title>Create an account - <?php echo $websiteName;?></title> 
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  
  <meta name="keywords" content="register on <?php echo $websiteName;?>, Create an account <?php echo $websiteName;?>" >
  <meta name="description" content="<?php echo $websiteProfileDESC;?>" > 
  <meta name="robots" content="index, follow"> 
  <meta name="robots" content="max-image-preview:standard">
  
<meta property="og:type" content="website" />
<meta property="og:title" content="register on <?php echo $websiteName;?>" />
...
<div class='container pt-3 pb-3 mt-2 mb-4'>
	<div class='row'>
		<div class="col-lg-8 col-md-12 col-sm-12">
			<?php include "includes/registerMenu.php";?>
		</div>
