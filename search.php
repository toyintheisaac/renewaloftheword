...
<html lang="en" >
<head>
	<title>Search || <?php echo $websiteName;?></title> 
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  
  <meta name="keywords" content="search, <?php echo $websiteProfileTags;?>"/>
  <meta name="description" content="<?php echo $websiteProfileDESC;?>"> 
  <meta name="robots" content="index, follow"> 
  
<meta property="og:type" content="website" />
<meta property="og:title" content="Search <?php echo $websiteName;?>" />
...
<div class='container pt-3 pb-3 mt-2 mb-4'>
	<div class='row'>
		<div class="col-lg-8 col-md-12 col-sm-12">
			<?php include "includes/searchContent.php";?>
		</div>
