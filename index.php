...
<html lang="en" >
<head>
	<title>Home - <?php echo $websiteName;?></title> 
 <meta charset="utf-8">
...
<meta property="og:title" content="Welcome to <?php echo $websiteName;?>" />
...
<div class='container pt-3 pb-3 mt-2 mb-4'>
	<div class='row'>
		<div class="col-lg-8 col-md-12 col-sm-12">
			<?php include "includes/indexSlider.php";?>
			<?php include "includes/mainContentMenu.php";?>
		</div>
